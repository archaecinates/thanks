 ...
 function handleClosePopup() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/bg-mawar.png')",
    ...
    <div className="fixed bottom-88 left-1/2 transform -translate-x-1/2 bg-white/24 backdrop-blur-md rounded-xl shadow-lg flex flex-col items-center gap-4 p-4 z-50 w-[300px]">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-16 h-16 mb-2">
          ...
          >
            <img src="/vinylm.png" alt="Vinyl" className="w-full h-full object-cover" />
          </div>
          <button
        ...
        <div className="text-center">
          <h3 className="text-sm font-semibold text-black" style={{ color: '#58483A', paddingTop: '10px' }}>
            Tebak laah
          </h3>
          <p className="text-xs text-gray-600" style={{ color: '#7C6654' }}>
            Sarah Kang
          </p>
        </div>
      </div>
      ...
      <audio ref={audioRef} src="/mawar.mp3" />
    </div>
  );
}
